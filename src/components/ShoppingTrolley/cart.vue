...
.content_container{
  ...
  input[type="checkbox"]:checked::before{content: "\2713";background-color: #fff;position: absolute;top: 0;left: 0;width:100%;border: 1px solid #ccc;color:#e50232;font-size: 13px;font-weight: bold;}
  .top{
    height: 95px;
    position: relative;
    // line-height: 95px;
